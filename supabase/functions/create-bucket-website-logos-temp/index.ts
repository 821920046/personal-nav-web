...
Deno.serve(async (req) => {
    ...
    bucketConfig.allowed_mime_types = ["image/png", "image/jpeg", "image/jpg", "image/svg+xml", "image/webp"];
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for website-logos" ON storage.objects FOR SELECT USING (bucket_id = 'website-logos');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for website-logos" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'website-logos');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for website-logos" ON storage.objects FOR UPDATE USING (bucket_id = 'website-logos');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for website-logos" ON storage.objects FOR DELETE USING (bucket_id = 'website-logos');`
    ];
